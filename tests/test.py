...
'''
    ...
    def test_dir_few(self):
        ...
        f_json.assert_json(lambda e: e["comm"] == "touch" and "W" in e["types"] and e["path"] == f"{re.escape(yes1)}/fileA")
        f_json.assert_json(lambda e: e["comm"] == "touch" and "W" in e["types"] and e["path"] == f"{re.escape(yes1)}/sub/fileB")
        f_json.assert_json(lambda e: e["comm"] == "touch" and "W" in e["types"] and e["path"] == f"{re.escape(yes2)}/fileC")
        f_json.assert_json(lambda e: e["comm"] == "touch" and "W" in e["types"] and e["path"] == f"{re.escape(yes2)}/sub/fileD")
        f_json.assert_json(lambda e: e["comm"] == "touch" and "W" in e["types"] and e["path"] == f"{re.escape(yes1)}/sub_moved/fileF")
        f_json.assert_not_json(lambda e: e["comm"] == "touch" and "W" in e["types"] and e["path"] == f"{re.escape(no1)}/fileE")
        f_json.assert_not_json(lambda e: e["comm"] == "touch" and "W" in e["types"] and e["path"] == f"{re.escape(no1)}/sub/fileF")
        f_json.assert_not_json(lambda e: e["comm"] == "touch" and "W" in e["types"] and e["path"] == f"{re.escape(no2)}/fileG")
        f_json.assert_not_json(lambda e: e["comm"] == "touch" and "W" in e["types"] and e["path"] == f"{re.escape(no2)}/sub/fileH")
        f_json.assert_not_json(lambda e: e["comm"] == "touch" and "W" in e["types"] and e["path"] == f"{re.escape(no2)}/sub_moved/fileB")
    ...
    def test_dir_many(self):
        ...
        for i in range(50):
            ...
            f.assert_not_log(rf"^touch([0-9]*): CW\?O\? \+{re.escape(nomany)}/new-dir-$a/file")
            f_json.assert_json(lambda e: e["comm"] == "touch" and "W" in e["types"] and e["path"] == f"{re.escape(yesmany)}/existing-dir-$a/file")
            f_json.assert_json(lambda e: e["comm"] == "touch" and "C" in e["types"] and e["path"] == f"{re.escape(yesmany)}/new-dir-$a/file")
            f_json.assert_not_json(lambda e: e["comm"] == "touch" and "W" in e["types"] and e["path"] == f"{re.escape(nomany)}/existing-dir-$a/file")
            f_json.assert_not_json(lambda e: e["comm"] == "touch" and "C" in e["types"] and e["path"] == f"{re.escape(nomany)}/new-dir-$a/file")
