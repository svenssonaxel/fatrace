...
'''
    ...
    def test_dir_many(self):
        ...
        for i in range(5):
            ...
            f_json.assert_json(lambda e: e["comm"] == "touch" and "W" in e["types"] and e["path"] == f"{yesmany}/existing-dir-$a/file")
            f_json.assert_json(lambda e: e["comm"] == "touch" and "C" in e["types"] and e["path"] == f"{yesmany}/new-dir-$a/file")
            f_json.assert_not_json(lambda e: e["comm"] == "touch" and "W" in e["types"] and e["path"] == f"{nomany}/existing-dir-$a/file")
            f_json.assert_not_json(lambda e: e["comm"] == "touch" and "C" in e["types"] and e["path"] == f"{nomany}/new-dir-$a/file")
